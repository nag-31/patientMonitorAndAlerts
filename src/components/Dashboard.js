...
import { fetchPatients, togglePatientCondition, fetchPatientById, checkDoctorLogin } from '../api/API'; // Import your API functions
...
const Dashboard = () => {
  ...
  // console.log("checkdoccondition",checkDoctorLogin().log===false)
  
if (!checkDoctorLogin().log===false) {
