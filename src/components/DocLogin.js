...
import { checkDocExists, updateDoctorLogin } from '../api/API';
// import { login } from '../Auth/Auth';

const LoginForm = ({ setIsDoc,isDoc }) => {
  ...
  const handleSubmit = async (values) => {
    try{
      ...
      if (docExists) {
        ...
        setIsDoc(true);
        updateDoctorLogin(true,{"username":values.username,"password":values.password,"id":docExists})
